...
export const batch3: Post[] = [
  {
    slug: 'meta-mainonnan-copywriting',
    title: 'Meta-mainonnan copywriting suomeksi — 5 rakennetta jotka toimivat',
    cats: ['Mainossisältö'],
    date: '5.7.2026',
    publishedTime: '2026-07-05T08:22:00+03:00',
    read: 6,
    grad: 'grad-1',
    excerpt: 'Meta-mainostekstin kirjoittaminen ei vaadi copywriterin koulutusta. Nämä 5 rakennetta toimivat suomalaiselle yleisölle.',
    content: `
      <p>Suurin osa Meta-mainostekstien ongelmista ei johdu sanavalinnoista vaan rakenteesta. Teksti lähtee liikkeelle yrityksen esittelystä, kertoo mitä yritys tekee, ja toivoo että lukija jaksaa loppuun asti. Hän ei jaksa. Hyvä mainosteksti seuraa rakennetta, joka vie lukijan ongelmasta toimintaan ilman että hän edes huomaa sitä.</p>
      <p>Et tarvitse copywriterin koulutusta. Tarvitset valmiin rungon, johon kirjoitat oman tarinasi. Tässä viisi rakennetta, jotka toimivat suomalaiselle yleisölle. Valitse se, joka sopii palveluusi, ja täytä se omilla sanoillasi.</p>
      ...
      <p>Pituudella ei ole yhtä oikeaa vastausta. Lyhyt teksti toimii, kun tarjous on yksinkertainen ja kuva tekee suurimman työn. Pidempi teksti toimii, kun palvelu vaatii selitystä tai luottamuksen rakentamista, esimerkiksi remontti tai hyvinvointipalvelu. Tärkeintä on että ensimmäinen rivi koukuttaa, jolloin lukija avaa lopun itse.</p>
      <h3>Pitääkö jokaiseen mainokseen kirjoittaa eri teksti?</h3>
      <p>Kannattaa. Tee samasta tarjouksesta kaksi tai kolme versiota eri rakenteilla ja anna niiden pyöriä rinnakkain. Näet datasta kumpi puhuttelee yleisöäsi, etkä joudu arvaamaan. Sama teksti kaikissa mainoksissa tarkoittaa että et opi mitään.</p>
      <h3>Saako mainostekstissä käyttää emojeita?</h3>
  ...
  {
    slug: 'meta-staattinen-kuva-vs-animaatio',
    title: 'Meta-mainonta: staattinen kuva vs. animaatio — kumpi tuo tuloksia',
    cats: ['Mainossisältö'],
    date: '6.7.2026',
    publishedTime: '2026-07-06T08:03:00+03:00',
    read: 4,
    grad: 'grad-2',
    excerpt: 'Kannattaako Meta-mainokseen tehdä animaatio vai riittääkö staattinen kuva? Käytännön vastaus.',
    content: `
      <p>Moni luulee, että liikkuva mainos voittaa aina paikallaan olevan, koska liike pysäyttää selauksen. Käytännössä asia ei ole näin yksinkertainen. Hyvä staattinen kuva päihittää huonon animaation joka kerta, ja monelle pienelle yritykselle staattinen kuva on järkevin paikka aloittaa.</p>

      <h2>Milloin staattinen kuva riittää</h2>
      <p>Staattinen kuva toimii, kun viesti on yksi ja selkeä. Ravintolan lounastarjous, kauneushoitolan uusi hoito, verkkokaupan tuote selkeästi esillä. Näissä lukijan ei tarvitse seurata kehittyvää tarinaa, hänen pitää nähdä yksi asia ja ymmärtää se sekunnissa.</p>
      <p>Staattisen kuvan etu on, että se on nopea tehdä ja halpa testata. Saat samalla vaivalla kolme erilaista kuvaa pyörimään ja näet mikä toimii. Hyvä staattinen kuva sisältää yhden selkeän kohteen, vähän tekstiä kuvan päällä ja värin joka erottuu syötteen sinivalkoisesta. Se ei vaadi videointiosaamista eikä editointiohjelmaa.</p>
      ...
      <p>Ei suoraan. Meta hinnoittelee näytöt sen mukaan, miten hyvin mainos sitouttaa yleisöä, ei sen mukaan onko se kuva vai video. Jos animaatio pitää katsojat pidempään, se voi jopa laskea kustannuksia. Huono video taas nostaa niitä.</p>
      <h3>Voinko tehdä animaation puhelimella?</h3>
  ...
  {
    slug: 'meta-mainonta-ravintolalle-creative',
    title: 'Meta-mainonta ravintolalle — näin suunnittelet toimivan mainoksen',
    cats: ['Mainossisältö'],
    date: '7.7.2026',
    publishedTime: '2026-07-07T09:24:00+03:00',
    read: 7,
    grad: 'grad-3',
    excerpt: 'Meta-mainos ravintolalle ei tarkoita ruokakuvaa ja aukioloaikoja. Näin suunnittelet mainoksen joka tuo pöytävarauksia.',
    content: `
      <p>Tyypillinen ravintolan Meta-mainos on kuva annoksesta, logo nurkassa ja teksti jossa lukee osoite ja aukioloajat. Se ei tuo varauksia, koska se ei anna kenellekään syytä toimia juuri nyt. Toimiva ravintolamainos myy hetken, ei ruokalistaa.</p>
      ...
      <p>Molemmissa. Instagram sopii erityisen hyvin ruoan ja tunnelman visuaaliseen esittelyyn ja tavoittaa nuorempaa yleisöä. Facebook tavoittaa laajemman ikähaarukan ja toimii hyvin paikallisessa kohdennuksessa. Anna saman mainoksen pyöriä molemmissa ja katso kumpi tuo varauksia.</p>
      <h3>Pitääkö ruokakuvat ottaa ammattikuvaajalla?</h3>
      <p>Ei välttämättä. Hyvällä luonnonvalolla ja puhtaalla taustalla puhelimella otettu kuva voi toimia erinomaisesti, ja aito kuva omasta annoksesta on uskottavampi kuin kiillotettu stockkuva. Tärkeintä on että kuva näyttää houkuttelevalta ja kertoo totuuden siitä mitä saa.</p>
      <h3>Kuinka usein ravintolan mainosta pitää vaihtaa?</h3>
  ...
  {
    slug: 'meta-mainonta-hyvinvointiyritykselle-creative',
    title: 'Meta-mainonta hyvinvointiyritykselle — näin suunnittelet toimivan mainoksen',
    cats: ['Mainossisältö'],
    date: '8.7.2026',
    publishedTime: '2026-07-08T10:49:00+03:00',
    read: 9,
    grad: 'grad-4',
    excerpt: 'Hyvinvointialan Meta-mainonnassa luottamus ratkaisee. Näin rakennat mainoksen joka vakuuttaa ja tuo ajanvarauksia.',
    content: `
      <p>Hyvinvointipalvelua ostetaan eri logiikalla kuin pitsaa. Ihminen päästää sinut lähelle kehoaan, mieltään tai terveyttään, ja se vaatii luottamusta. Siksi hyvinvointialan Meta-mainos ei voi olla pelkkä tarjous ja kaunis kuva. Sen pitää vakuuttaa, että olet osaava ja turvallinen valinta.</p>
      ...
      <p>Lyhyt video, jossa kerrot itse tilanteesta tai esittelet tilan, on poikkeuksellisen tehokas. Se yhdistää kasvot, äänen ja tunnelman, ja se rakentaa luottamusta nopeammin kuin teksti koskaan.</p>
      ...
      <p>Saa, mutta terveyteen liittyviä väittämiä valvotaan tarkasti. Vältä lupaamasta parantumista tai takaamasta tuloksia, äläkä käytä ennen ja jälkeen -kuvia tavalla joka lupaa kehon muutoksen. Kuvaa palvelua ja asiakaskokemusta, niin pysyt sääntöjen sisällä.</p>
      <h3>Kannattaako näkyä mainoksessa itse?</h3>
      <p>Kyllä, varsinkin jos olet pienen yrityksen ainoa tai pääasiallinen hoitaja. Ihmiset varaavat ajan henkilölle, ja kasvojen näkeminen madaltaa kynnystä merkittävästi. Lyhyt video jossa puhut suoraan katsojalle toimii erityisen hyvin.</p>
      <h3>Mikä on hyvä ensimmäinen tarjous uudelle asiakkaalle?</h3>
      <p>Matalan kynnyksen aloitus toimii parhaiten: maksuton kartoitus, edullinen tutustumiskäynti tai lyhyt puhelu. Tavoite ei ole tehdä koko myyntiä mainoksessa vaan saada asiakas kokeilemaan kerran. Jatkokäynnit syntyvät kokemuksen jälkeen.</p>
      <h3>Toimivatko asiakaspalautteet mainoksissa?</h3>
      <p>Erittäin hyvin, koska luottamus ratkaisee tällä alalla. Aito lainaus asiakkaalta, joka kuvaa konkreettisesti miten tilanne parani, vakuuttaa enemmän kuin omat lupauksesi. Pyydä lupa palautteen käyttöön ja pidä se aitona, älä siloita liikaa.</p>
      <h3>Kuinka nopeasti hyvinvointiyritys näkee tuloksia mainonnasta?</h3>
      <p>Ensimmäisiä yhteydenottoja voi tulla jo ensimmäisinä viikkoina, mutta koska ostopäätös vaatii luottamusta, koko hyöty näkyy usein vasta kun ensimmäiset asiakkaat ovat käyneet ja palanneet. Anna kampanjalle muutama viikko aikaa kerätä dataa ennen johtopäätöksiä.</p>
  ...
  {
    slug: 'meta-mainonnan-mittarit',
    title: 'Meta-mainonnan mittarit — mitkä oikeasti merkitsevät tuloksille',
    cats: ['Mittarit & raportointi'],
    date: '9.7.2026',
    publishedTime: '2026-07-09T07:44:00+03:00',
    read: 6,
    grad: 'grad-5',
    excerpt: 'Meta Ads Manager täynnä lukuja — mutta mitkä niistä oikeasti kertovat jotain? Tässä mittarit joihin kannattaa keskittyä.',
    content: `
      <p>Meta Ads Manager näyttää kymmeniä sarakkeita lukuja, ja useimmat niistä eivät kerro sinulle mitään hyödyllistä. Suuri osa yrittäjistä tuijottaa vääriä lukuja: tykkäyksiä, näyttökertoja, tavoittavuutta. Ne tuntuvat hyviltä mutta eivät maksa laskuja. Tässä ne mittarit, jotka oikeasti kertovat tuottaako mainonta vai ei.</p>
      ...
      <p>Konversion hinta, eli paljonko yksi varaus, osto tai yhteydenotto maksoi. Se yhdistää sekä tulosten määrän että niiden kannattavuuden. Jos tämä luku on kunnossa, mainonta toimii, vaikka muut luvut näyttäisivät keskinkertaisilta.</p>
      <h3>Miksi mainos saa paljon tykkäyksiä mutta vähän myyntiä?</h3>
      <p>Koska tykkäys on ilmainen ja helppo reaktio, kun taas osto vaatii rahaa ja päätöksen. Viihdyttävä mainos voi kerätä sitoutumista herättämättä ostohalua. Keskity konversioihin ja niiden hintaan, älä sosiaalisiin reaktioihin.</p>
      <h3>Kuinka usein mittareita kannattaa tarkistaa?</h3>
  ...
  {
    slug: 'meta-mainonnan-roas',
    title: 'Meta-mainonnan ROAS selitettynä — mitä se tarkoittaa ja mikä on hyvä tulos',
    cats: ['Mittarit & raportointi'],
    date: '10.7.2026',
    publishedTime: '2026-07-10T07:40:00+03:00',
    read: 5,
    grad: 'grad-1',
    excerpt: 'ROAS on Meta-mainonnan tärkein mittari verkkokaupalle. Tässä mitä se tarkoittaa, miten se lasketaan ja mikä on realistinen tavoite.',
    content: `
      <p>ROAS on lyhenne sanoista return on ad spend, eli mainoseuron tuotto. Se vastaa yhteen kysymykseen: kuinka monta euroa myyntiä saat jokaista mainontaan käyttämääsi euroa kohti. Verkkokaupalle se on yleensä tärkein yksittäinen luku, koska se kertoo suoraan kannattaako mainonta vai ei.</p>

      <h2>Näin ROAS lasketaan</h2>
      <p>Laskukaava on yksinkertainen: jaa mainonnan tuoma myynti mainoskuluilla. Jos käytit tuhat euroa mainontaan ja se tuotti neljätuhatta euroa myyntiä, ROAS on neljä. Toisin sanoen jokainen mainoseuro toi neljä euroa myyntiä takaisin. ROAS kaksi tarkoittaa kaksinkertaista, ROAS yksi tarkoittaa että myynti vastasi tasan mainoskuluja.</p>
      <p>Meta laskee tämän luvun automaattisesti, jos olet asentanut seurannan oikein ja kerrot Metalle ostosten arvon. Ilman toimivaa seurantaa ROAS-luku ei ole luotettava, koska Meta ei tiedä paljonko mainonta oikeasti tuotti.</p>
      ...
      <p>Siksi kannattaa katsoa ROASia yhdessä myynnin kokonaismäärän kanssa. Joskus on järkevää hyväksyä matalampi ROAS, jos se tuo paljon uusia asiakkaita, jotka ostavat myöhemmin uudelleen. Ensimmäisen kaupan kannattavuus ei kerro koko totuutta, jos asiakas palaa.</p>

      <h2>ROAS sopii myynnille, ei kaikelle</h2>
      <p>ROAS on verkkokaupan mittari, koska siellä jokaisella ostolla on selkeä euromääräinen arvo. Palveluyritykselle, joka kerää yhteydenottoja tai varauksia, ROAS ei toimi suoraan, koska yhden liidin arvoa on vaikea laskea hetkessä. Tällöin parempi mittari on liidin tai varauksen hinta suhteessa siihen, paljonko asiakas tuo elinkaarensa aikana.</p>

      <h2>Usein kysytyt kysymykset</h2>
      <h3>Mikä ROAS on tarpeeksi hyvä?</h3>
      <p>Se, jolla jää voittoa katteen ja muiden kulujen jälkeen. Korkeakatteiselle tuotteelle matalakin ROAS riittää, ohutkatteiselle tarvitaan selvästi korkeampi. Laske oma kannattavuusrajasi, älä luota yleisiin nyrkkisääntöihin.</p>
      <h3>Miksi Metan näyttämä ROAS ja kirjanpidon luvut eivät täsmää?</h3>
      <p>Meta kirjaa myynnit oman seurantansa ja attribuutionsa mukaan, mikä voi poiketa todellisesta myynnistä. Osa ostoista jää seurannan ulkopuolelle ja osa kirjautuu mainonnan ansioksi, vaikka asiakas olisi tullut muutenkin. Käytä Metan ROASia suuntaa antavana lukuna ja vertaa sitä kokonaismyyntiin.</p>
      <h3>Voiko ROAS olla liian korkea?</h3>
  ...
  {
    slug: 'meta-ads-cpm-cpc-ctr',
    title: 'Meta Ads CPM, CPC ja CTR — mitä nämä tarkoittavat käytännössä',
    cats: ['Mittarit & raportointi'],
    date: '11.7.2026',
    publishedTime: '2026-07-11T08:27:00+03:00',
    read: 4,
    grad: 'grad-2',
    excerpt: 'CPM, CPC, CTR — Meta Ads Manager on täynnä lyhenteitä. Tässä mitä ne tarkoittavat ja miten käytät niitä päätöksenteossa.',
    content: `
      <p>Meta Ads Manager heittää eteesi joukon lyhenteitä ilman selitystä. Kolme niistä toistuu jatkuvasti: CPM, CPC ja CTR. Kun ymmärrät nämä kolme, osaat lukea suuren osan mainonnan terveydentilasta. Tässä mitä ne tarkoittavat ja mihin kutakin käytetään.</p>

      <h2>CPM: paljonko yleisön tavoittaminen maksaa</h2>
      <p>CPM tarkoittaa tuhannen näyttökerran hintaa, eli paljonko maksat siitä että mainoksesi näytetään tuhat kertaa. Se kertoo, kuinka kallista yleisösi tavoittaminen on Metassa juuri nyt.</p>
      <p>CPM nousee, kun kilpailu samasta yleisöstä kiristyy, esimerkiksi sesonkiaikaan kuten ennen joulua. Se nousee myös, jos mainoksesi alkaa kyllästyttää yleisöä ja Meta joutuu työntämään sitä kalliimmin. CPM yksinään ei ole hyvä tai huono, vaan se on tausta jota vasten muita lukuja luetaan.</p>
      ...
      <p>CPC on hyödyllinen vertailtaessa eri mainoksia tai yleisöjä keskenään. Halvin klikki ei silti aina voita, koska tärkeintä on mitä klikkauksen jälkeen tapahtuu. Sata halpaa klikkiä, joista yksikään ei osta, on huonompi kuin kymmenen kalliimpaa, joista kolme ostaa.</p>
      ...
      <h2>Usein kysytyt kysymykset</h2>
      <h3>Mikä on hyvä CTR?</h3>
      <p>Hyvä CTR vaihtelee toimialoittain ja sijoittelun mukaan, joten yksittäistä tavoitelukua tärkeämpää on oma kehitys. Vertaa mainostesi CTR:ää toisiinsa ja pyri nostamaan sitä paremmalla kuvalla ja tekstillä. Nouseva CTR tarkoittaa että mainos toimii paremmin.</p>
      <h3>Pitäisikö minun pyrkiä mahdollisimman halpaan CPC:hen?</h3>
  ...
  {
    slug: 'meta-ads-vs-google-analytics',
    title: 'Meta Ads vs. Google Analytics — miksi ne raportoivat eri tuloksia',
    cats: ['Mittarit & raportointi'],
    date: '12.7.2026',
    publishedTime: '2026-07-12T09:22:00+03:00',
    read: 7,
    grad: 'grad-3',
    excerpt: 'Meta sanoo 20 konversiota, Google Analytics sanoo 8. Kumpi on oikeassa? Selitämme mistä ero tulee ja miten tulkita lukuja oikein.',
    content: `
      <p>Avaat Meta Ads Managerin ja se kertoo että mainonta toi kaksikymmentä ostoa. Avaat Google Analyticsin ja se näyttää kahdeksan. Sama viikko, sama kauppa, eri luku. Kumpi on oikeassa? Lyhyt vastaus: molemmat, omasta näkökulmastaan. Ne mittaavat asioita eri tavalla, eivätkä ne koskaan täsmää täysin.</p>

      <h2>Ero ei ole virhe, vaan eri logiikka</h2>
      <p>Meta ja Google Analytics laskevat konversioita eri säännöillä. Kun ymmärrät säännöt, ero lakkaa hämmentämästä. Kaksi suurinta syytä eroon ovat attribuutio ja seurannan kattavuus.</p>

      <h2>Attribuutio: kuka saa kunnian myynnistä</h2>
      ...
      <p>Meta paikkaa tätä omilla menetelmillään ja arvioi osan konversioista mallintamalla, eli se arvaa tilastollisesti myyntejä joita ei nähnyt suoraan. Google Analytics taas perustuu enemmän siihen mitä se konkreettisesti mittasi. Siksi Meta näyttää usein suurempia lukuja: se sekä kerää itselleen pohjustavat myynnit että täydentää aukkoja mallinnuksella.</p>
      ...
      <h2>Usein kysytyt kysymykset</h2>
      <h3>Kumpi luku on lähempänä totuutta?</h3>
      <p>Kumpikaan ei ole täysi totuus. Meta yliarvioi usein, koska se kerää itselleen myös pohjustavat ja mallinnetut myynnit. Analytics aliarvioi mainonnan vaikutusta, koska se antaa kunnian viimeiselle kanavalle. Todellinen myynti löytyy kirjanpidosta, ja sitä vasten molempia kannattaa lukea.</p>
      <h3>Voinko saada luvut täsmäämään?</h3>
      <p>Et täysin, etkä sitä kannata yrittääkään. Erilainen attribuutiologiikka ja seurannan rajoitukset takaavat, että luvut poikkeavat aina. Tavoite ei ole saada niitä samaksi vaan ymmärtää miksi ne eroavat.</p>
      <h3>Pitäisikö minun muuttaa Metan attribuutioasetuksia?</h3>
  ...
  {
    slug: 'meta-mainonnan-attribution-window',
    title: 'Meta-mainonnan attribution window — mikä se on ja miksi se vaikuttaa tuloksiisi',
    cats: ['Mittarit & raportointi'],
    date: '13.7.2026',
    publishedTime: '2026-07-13T09:20:00+03:00',
    read: 7,
    grad: 'grad-4',
    excerpt: 'Attribution window määrittää miten Meta laskee konversiot. Väärä asetus voi vääristää tuloksia merkittävästi. Selitämme miten se toimii.',
    content: `
      <p>Attribution window eli attribuutioikkuna on asetus, joka päättää milloin Meta saa laskea myynnin mainoksen ansioksi. Se on yksi tärkeimmistä mutta vähiten ymmärretyistä asetuksista, ja väärin valittuna se voi saada mainonnan näyttämään paljon paremmalta tai huonommalta kuin se oikeasti on.</p>

      <h2>Mistä on kyse</h2>
      <p>Kun ihminen näkee tai klikkaa mainostasi, hän ei aina osta heti. Hän voi miettiä päivän tai kaksi, palata sitten ja ostaa. Attribuutioikkuna määrittää, kuinka pitkän ajan sisällä tämä myöhempi osto vielä lasketaan mainoksen ansioksi.</p>
      <p>Ikkunassa on kaksi osaa. Klikin jälkeinen ikkuna tarkoittaa aikaa siitä, kun ihminen klikkasi mainosta. Näytön jälkeinen ikkuna tarkoittaa aikaa siitä, kun ihminen vain näki mainoksen klikkaamatta. Meta antaa valita näiden pituuden, esimerkiksi laskeeko se vain klikin jälkeiset ostot lyhyellä aikavälillä vai myös pidemmän ajan kuluessa tapahtuneet.</p>
      ...
      <h2>Yleisin virhe</h2>
      <p>Yleisin virhe on vertailla kahta kampanjaa, joilla on eri attribuutioikkuna, ja päätellä että toinen on kannattavampi. Ero voi johtua pelkästään asetuksesta, ei todellisesta tuloksesta. Pidä ikkuna samana kaikissa raporteissasi, niin lukusi ovat keskenään vertailukelpoisia.</p>
      <p>Toinen sudenkuoppa on unohtaa, että pitkä ikkuna laskee mukaan myös ostoja, jotka olisivat tapahtuneet muutenkin. Mitä pidempi ikkuna, sitä todennäköisemmin mukaan lipsahtaa myyntiä, jolla ei ole todellista yhteyttä mainokseen.</p>

      <h2>Usein kysytyt kysymykset</h2>
      <h3>Mikä attribuutioikkuna on yleisimmin käytössä?</h3>
      <p>Moni käyttää kohtuullisen lyhyttä klikin jälkeistä ikkunaa yhdistettynä lyhyeen näytön jälkeiseen ikkunaan. Tämä antaa tasapainoisen kuvan ilman, että tulokset paisuvat liikaa. Tärkeintä ei kuitenkaan ole noudattaa muiden valintaa vaan sovittaa ikkuna oman myyntisyklisi pituuteen.</p>
      <h3>Voiko ikkunan vaihtaminen muuttaa menneitä tuloksia raportissa?</h3>
      <p>Kyllä, koska sama data näytetään eri säännöillä. Jos vaihdat ikkunaa, aiemmatkin luvut näyttävät erilaisilta raportissa, vaikka itse myynti ei muuttunut. Tämä on yksi syy hämmennykseen, kun luvut tuntuvat muuttuvan itsestään.</p>
      <h3>Pitäisikö pitkän harkinnan tuotteille valita aina pisin ikkuna?</h3>
  ...
  {
    slug: 'meta-ads-raportin-lukeminen',
    title: 'Meta Ads -raportin lukeminen ilman markkinointikoulutusta',
    cats: ['Mittarit & raportointi'],
    date: '14.7.2026',
    publishedTime: '2026-07-14T08:06:00+03:00',
    read: 7,
    grad: 'grad-5',
    excerpt: 'Meta Ads Manager voi tuntua ylivoimaiselta. Tässä miten luet raporttia, mitä lukuja katsot ensin ja mitä ne kertovat.',
    content: `
      <p>Meta Ads Manager avautuu eteesi seinänä lukuja, sarakkeita ja termejä, joista suurin osa ei kerro sinulle mitään. Hyvä uutinen on, että et tarvitse markkinointikoulutusta lukeaksesi raporttia. Tarvitset järjestyksen, jossa katsot asioita, ja muutaman luvun johon keskityt. Loput voit jättää huomiotta.</p>

      <h2>Katso ensin oikealta tasolta</h2>
      <p>Meta-mainonta jakautuu kolmeen tasoon: kampanja ylimpänä, sen alla mainosjoukot ja niiden alla yksittäiset mainokset. Raporttia kannattaa lukea ylhäältä alas. Aloita kampanjatasolta nähdäksesi kokonaiskuvan, sukella sitten mainosjoukkoihin ja lopuksi yksittäisiin mainoksiin selvittääksesi mikä toimii ja mikä ei.</p>
      <p>Tämä järjestys estää eksymästä. Jos hyppäät suoraan yksittäisten mainosten lukuihin, et näe metsää puilta. Kokonaiskuva ensin, yksityiskohdat sitten.</p>
      ...
      <p>Älä tee tätä liian aikaisin. Anna jokaiselle mainokselle riittävästi aikaa ja näyttöjä, ennen kuin tuomitset sen. Yhden päivän luvut heittelevät, eivätkä kerro totuutta.</p>

      <h2>Mitä voit jättää huomiotta</h2>
      <p>Suuri osa sarakkeista on kohinaa pienelle yritykselle. Tykkäykset, kommentit, jaot ja pelkkä tavoittavuus tuntuvat tärkeiltä mutta eivät kerro kannattavuudesta. Älä anna niiden viedä huomiota tuloksista ja niiden hinnasta. Voit halutessasi piilottaa turhat sarakkeet näkymästä ja jättää näkyviin vain ne, joita oikeasti käytät päätöksentekoon.</p>
      ...
      <p>Se riippuu kampanjasi tavoitteesta. Jos tavoittelet ostoja, tulos on ostojen määrä. Jos tavoittelet yhteydenottoja tai varauksia, tulos on niiden määrä. Meta näyttää tämän tulokset-sarakkeessa valitsemasi tavoitteen mukaan. Varmista, että kampanjan tavoite vastaa sitä mitä oikeasti haluat.</p>
      <h3>Kuinka usein raporttia kannattaa katsoa?</h3>
      <p>Kerran viikossa riittää useimmille. Päivittäinen tarkkailu johtaa ylireagointiin, koska yksittäisten päivien luvut heilahtelevat luonnostaan. Anna datan kertyä, niin teet parempia päätöksiä.</p>
      <h3>Mitä teen jos en ymmärrä jotain saraketta?</h3>
