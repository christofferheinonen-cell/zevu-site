...
export const batch4: Post[] = [
  {
    slug: 'meta-mainonnan-frequency',
    title: 'Meta-mainonnan frequency — milloin mainoksesi näytetään liian usein',
    cats: ['Mittarit & raportointi'],
    date: '15.7.2026',
    publishedTime: '2026-07-15T09:14:00+03:00',
    read: 4,
    grad: 'grad-1',
    excerpt: 'Frequency kertoo kuinka monta kertaa sama henkilö on nähnyt mainoksesi. Liian korkea frequency tappaa kampanjan. Näin hallitset sitä.',
    content: `
      <p>Tulokset olivat hyviä kaksi viikkoa, sitten ne romahtivat. Sama mainos, sama budjetti, sama yleisö. Yleisin syy tähän on frequency, eli kuinka monta kertaa keskimäärin sama ihminen on nähnyt mainoksesi. Kun sama kasvohoitomainos osuu silmille kahdeksannen kerran viikossa, ihminen ei enää reagoi. Hän selaa ohi tai pahimmillaan piilottaa mainoksen.</p>
      <p>Frequency lasketaan yksinkertaisesti: näyttökerrat jaettuna tavoitetuilla ihmisillä. Jos mainoksesi on saanut tuhat näyttöä mutta tavoittanut vain sata ihmistä, frequency on kymmenen. Sama sata ihmistä on nähnyt mainoksen kymmenen kertaa. Se on liikaa.</p>
      ...
      <h3>Mistä näen frequencyn Ads Managerissa?</h3>
      <p>Lisää sarakenäkymään Frequency, niin näet sen kampanja-, mainosjoukko- ja mainostasolla. Valitse aikaväliksi viimeiset 7 tai 14 päivää, koska koko kampanjan elinajan frequency ei kerro nykytilanteesta mitään.</p>
      <h3>Onko korkea frequency aina huono asia?</h3>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Ensimmäiset yhteydenotot tai myynnit voivat tulla jo ensimmäisellä viikolla, mutta luotettavan kuvan saat vasta muutaman kuukauden jälkeen. Älä tee isoja päätöksiä oppimisvaiheen heittelyiden perusteella.</p>
      <h3>Mikä on realistinen kuukausibudjetti pienelle yritykselle?</h3>
      <p>Budjetin pitää olla riittävä, jotta Meta saa kerättyä dataa optimointiin. Liian pieni budjetti pidetään kampanjan oppimisvaiheessa jumissa, jolloin tulokset jäävät heikoiksi riippumatta siitä kuinka hyvä mainos on.</p>
      <h3>Voiko Meta-mainonnalta odottaa heti voittoa?</h3>
  ...
  {
    slug: 'meta-ads-raportti-yritykselle',
    title: 'Meta Ads -raportti yritykselle — mitä siihen kannattaa sisällyttää',
    cats: ['Mittarit & raportointi'],
    date: '17.7.2026',
    publishedTime: '2026-07-17T09:10:00+03:00',
    read: 9,
    grad: 'grad-3',
    excerpt: 'Teetkö Meta-mainontaa asiakkaalle tai haluat seurata tuloksia itse? Nämä asiat kuuluvat hyvään Meta Ads -raporttiin.',
    content: `
      <p>Tyypillinen Meta Ads -raportti on ruutukaappaus Ads Managerista täynnä lukuja, joita kukaan ei ymmärrä. Hyvä raportti vastaa kolmeen kysymykseen: mitä rahalla saatiin, kannattiko se, ja mitä tehdään seuraavaksi. Jos raportti ei vastaa näihin, se on vain numeroita näytöllä.</p>
      <p>Tämä pätee yhtä lailla silloin kun teet mainontaa asiakkaalle ja silloin kun seuraat omaa mainontaasi. Tavoite on sama: nähdä yhdellä silmäyksellä onko tämä kannattavaa.</p>
      ...
      <p>Tukevia lukuja voi pitää erillisellä rivillä niille jotka haluavat syvemmälle: kuinka moni näki mainoksen, kuinka moni klikkasi ja paljonko klikki maksoi. Nämä auttavat diagnosoimaan ongelmia, mutta ne eivät ole pääosassa. Klikkien määrä ei maksa palkkoja, kaupat maksavat.</p>
      ...
      <h2>Usein kysytyt kysymykset</h2>
      <h3>Riittääkö pelkkä ruutukaappaus Ads Managerista?</h3>
      <p>Ei. Ads Manager näyttää kaiken datan kerralla ilman tulkintaa. Raportin tehtävä on poimia olennainen, verrata sitä tavoitteeseen ja selittää mitä luvut tarkoittavat juuri tälle yritykselle.</p>
      <h3>Mitkä luvut voin jättää pois?</h3>
      <p>Useimmat. Jätä pois mittarit joita et käytä päätöksentekoon. Jos luku ei muuta sitä mitä teet seuraavaksi, se on raportissa vain täytteenä ja hämärtää tärkeät luvut.</p>
      <h3>Pitääkö raportissa näkyä myös huonot uutiset?</h3>
  ...
  {
    slug: 'ios-14-vaikutus-meta-mainontaan',
    title: 'iOS 14.5 vaikutus Meta-mainonnan raportointiin — mitä se tarkoittaa vielä tänään',
    cats: ['Mittarit & raportointi'],
    date: '18.7.2026',
    publishedTime: '2026-07-18T09:47:00+03:00',
    read: 9,
    grad: 'grad-4',
    excerpt: 'iOS 14.5 muutti Meta-mainonnan seurannan pysyvästi. Mitä se tarkoittaa käytännössä tänään — ja miten se vaikuttaa sinun kampanjoihisi.',
    content: `
      <p>Vuonna 2021 Apple antoi iPhonen käyttäjille mahdollisuuden kieltää sovellusten seurannan yhdellä napilla. Valtaosa painoi kieltoa. Tämä iOS 14.5 -päivitys ei ollut ohimenevä uutinen, vaan se muutti pysyvästi sitä miten Meta näkee mitä mainostesi jälkeen tapahtuu. Vaikutus näkyy kampanjoissasi vielä tänään, ja se selittää monta hämmentävää lukua raporteissa.</p>
      ...
      <h2>Usein kysytyt kysymykset</h2>
      <h3>Onko iOS 14.5 -ongelma jo ohi vuonna 2026?</h3>
      <p>Ei. Se ei ollut tilapäinen vika vaan pysyvä muutos siihen, miten seuranta toimii. Vaikutus on tänään osa arkea, ja siihen sopeudutaan palvelinpuolen seurannalla, ei odottamalla että vanha tilanne palaisi.</p>
      <h3>Tarkoittaako tämä että Meta-mainonta ei enää kannata?</h3>
      <p>Ei lainkaan. Mainonta toimii edelleen, mutta sen tulosten mittaaminen on epätarkempaa. Yritykset jotka ottivat käyttöön palvelinpuolen seurannan ja oppivat lukemaan kokonaiskuvaa, mainostavat yhä kannattavasti.</p>
      <h3>Mikä on Conversions API yksinkertaisesti selitettynä?</h3>
  ...
  {
    slug: 'meta-pixel-mita-on',
    title: 'Meta Pixel: mikä se on ja miksi jokainen verkkokauppa tarvitsee sen',
    cats: ['Meta-pikseli'],
    date: '19.7.2026',
    publishedTime: '2026-07-19T10:25:00+03:00',
    read: 8,
    grad: 'grad-5',
    excerpt: 'Meta Pixel on pieni koodinpätkä joka muuttaa Meta-mainonnan tehokkaaksi. Tässä mitä se tekee ja miksi ilman sitä mainostaminen on arvailua.',
    content: `
      <p>Ilman Meta Pixeliä mainostat sokkona. Maksat näyttökerroista ja klikeistä, mutta et tiedä kuka osti, kuka jätti ostoskorin tai kannattiko mikään. Meta Pixel on pieni koodinpätkä verkkosivullasi, joka kertoo Metalle mitä ihmiset tekevät klikattuaan mainostasi. Se muuttaa mainonnan arvauksesta mitattavaksi.</p>
      ...
      <p>Kyllä, jos mainostat. Pixel seuraa myös yhteydenottoja, lomakkeen täyttöjä ja soittonappien painalluksia. Palveluyritykselle se kertoo mitkä mainokset tuottivat ajanvarauksia ja tarjouspyyntöjä.</p>
      <h3>Kerääkö Pixel henkilötietoja minulle näkyviin?</h3>
      <p>Et näe yksittäisten ihmisten tietoja. Pixel tuottaa sinulle koottua tietoa tapahtumista ja yleisöistä. Yksittäisen kävijän henkilöllisyys ei näy raporteissasi.</p>
      <h3>Riittääkö Pixel yksin vai tarvitsenko muutakin?</h3>
  ...
  {
    slug: 'meta-pixelin-asentaminen-wordpress',
    title: 'Meta Pixelin asentaminen WordPress-sivulle — vaihe vaiheelta',
    cats: ['Meta-pikseli'],
    date: '20.7.2026',
    publishedTime: '2026-07-20T09:39:00+03:00',
    read: 6,
    grad: 'grad-1',
    excerpt: 'Meta Pixelin asentaminen WordPressiin ei vaadi koodausosaamista. Näin teet sen oikein muutamassa minuutissa.',
    content: `
      ...
      <p>Et. Koko prosessi hoituu lisäosalla ja yhden numerosarjan kopioinnilla. Manuaalista koodin liittämistä teemaan ei suositella, koska se katoaa päivityksissä.</p>
      <h3>Mikä lisäosa kannattaa valita?</h3>
      <p>WooCommerce-kaupalle Metan oma virallinen integraatio on paras, koska se tuo tuotetiedot mukanaan. Tavalliselle sivustolle riittää kevyt seurantalisäosa. Vältä useamman päällekkäisen Pixel-lisäosan käyttöä, koska se voi aiheuttaa tuplaseurantaa.</p>
      <h3>Miten tiedän että asennus onnistui?</h3>
  ...
  {
    slug: 'meta-pixel-vs-conversions-api',
    title: 'Meta Pixel vs. Conversions API — mitä eroa on ja tarvitsetko molemmat',
    cats: ['Meta-pikseli'],
    date: '21.7.2026',
    publishedTime: '2026-07-21T09:28:00+03:00',
    read: 6,
    grad: 'grad-2',
    excerpt: 'Meta Pixel ja Conversions API tekevät samaa asiaa — melkein. Selitämme mitä eroa on ja tarvitsetko molemmat vai riittääkö toinen.',
    content: `
      <p>Meta Pixel ja Conversions API yrittävät ratkaista saman ongelman: kertoa Metalle mitä ihmiset tekevät klikattuaan mainostasi. Ero on siinä, mistä tieto lähetetään. Pixel lähettää sen kävijän selaimesta. Conversions API lähettää sen verkkosivusi palvelimelta. Tämä pieni ero ratkaisee yllättävän paljon.</p>

      <h2>Pixel: selaimen kautta</h2>
      ...
      <p>Käytännössä siis: pelkkä Pixel jättää osan tuloksista näkymättömiin. Pelkkä CAPI ei ole tavallisesti edes järkevä lähtökohta. Yhdessä ne antavat täydellisimmän mahdollisen kuvan nykyisten rajoitusten puitteissa.</p>
      ...
      <p>Teknisesti voi, mutta sitä ei suositella useimmille. Pixel hoitaa osan toiminnoista kätevästi selainpuolella, ja yhdistelmä antaa kattavimman datan. Lähtökohta on Pixel ja sen rinnalle CAPI.</p>
      <h3>Lasketaanko ostos kahdesti jos käytän molempia?</h3>
      <p>Ei, kun asennus on tehty oikein. Meta tunnistaa saman tapahtuman molemmista lähteistä ja poistaa päällekkäisyyden. Tämä vaatii että tapahtumille välitetään yhteinen tunniste, jonka valmiit integraatiot hoitavat automaattisesti.</p>
      <h3>Kuinka paljon dataa CAPI palauttaa?</h3>
  ...
  {
    slug: 'meta-pixel-tapahtumat',
    title: 'Meta Pixel -tapahtumat — mitä tapahtumia sinun pitää seurata',
    cats: ['Meta-pikseli'],
    date: '22.7.2026',
    publishedTime: '2026-07-22T08:26:00+03:00',
    read: 8,
    grad: 'grad-3',
    excerpt: 'Meta Pixel voi seurata kymmenittäin eri tapahtumia. Mitkä niistä oikeasti merkitsevät? Tässä mitä seurata toimialakohtaisesti.',
    content: `
      <p>Meta Pixel osaa seurata kymmeniä erilaisia tapahtumia, mutta useimmat niistä eivät kerro sinulle mitään hyödyllistä. Tapahtuma on yksinkertaisesti toiminto jonka kävijä tekee sivullasi: katsoo sivua, lisää tuotteen koriin, ostaa, täyttää lomakkeen. Olennaista ei ole seurata kaikkea, vaan seurata sitä yhtä tapahtumaa joka vastaa rahaa.</p>

      <h2>Tärkein periaate: yksi tapahtuma on kuningas</h2>
      <p>Jokaisella yrityksellä on yksi tapahtuma, joka merkitsee enemmän kuin muut. Verkkokaupalle se on osto. Palveluyritykselle se on yhteydenotto tai ajanvaraus. Tätä kutsutaan konversioksi, ja se on se toiminto jonka optimointiin Meta keskittyy. Kaikki muut tapahtumat ovat tukea, jotka auttavat ymmärtämään polkua kohti tuota päämäärää.</p>
      <p>Yleisin virhe on optimoida johonkin pikkutapahtumaan kuten sivunkatseluun, koska niitä tulee paljon ja luvut näyttävät hyviltä. Sivunkatselut eivät maksa palkkoja. Optimoi siihen mikä tuo rahaa, vaikka niitä tapahtumia tulisi vähemmän.</p>
      ...
      <p>Ei. Useimmat niistä eivät koske liiketoimintaasi. Valitse yksi ydintapahtuma joka vastaa rahaa, ja muutama tukitapahtuma joka kuvaa polkua sinne.</p>
      <h3>Mihin tapahtumaan minun pitäisi optimoida?</h3>
      <p>Ydintapahtumaan, eli ostoon tai yhteydenottoon. Jos näitä tulee liian vähän jotta Meta oppisi, voit väliaikaisesti optimoida lähimpään tukitapahtumaan kuten koriin lisäykseen, mutta tavoite on aina päästä optimoimaan itse rahaan.</p>
      <h3>Miten seuraan yhteydenottolomakkeen täyttöä oikein?</h3>
  ...
  {
    slug: 'meta-pixelin-testaaminen',
    title: 'Meta Pixelin testaaminen — näin varmistat että se toimii oikein',
    cats: ['Meta-pikseli'],
    date: '23.7.2026',
    publishedTime: '2026-07-23T10:06:00+03:00',
    read: 4,
    grad: 'grad-4',
    excerpt: 'Miten tiedät toimiiko Meta Pixel oikein? Tässä miten testaat sen — ja mitä teet jos se ei toimi.',
    content: `
      <p>Asensit Meta Pixelin, mutta toimiiko se oikeasti? Tämä on tärkeä kysymys, koska rikkinäinen Pixel näyttää usein samalta kuin toimiva, kunnes huomaat ettei mikään konversio kirjaudu. Onneksi testaaminen vie vain muutaman minuutin, etkä tarvitse siihen teknistä osaamista.</p>

      <h2>Testi 1: Onko Pixel ylipäätään aktiivinen</h2>
      <p>Asenna selaimeesi Metan ilmainen Meta Pixel Helper -laajennus. Avaa sitten oma verkkosivusi ja klikkaa laajennuksen kuvaketta. Jos Pixel on asennettu, se näyttää vihreänä Pixelin tunnisteen ja kertoo että sivunkatselu kirjautui. Jos se ei löydä mitään, Pixel ei ole sivulla lainkaan tai sitä estää jokin asetus.</p>
      <p>Helper varoittaa myös yleisistä virheistä, kuten siitä että sama Pixel on asennettu kahdesti. Tuplaseuranta vääristää lukuja, joten tämä kannattaa korjata heti.</p>
      ...
      <h2>Mitä teet jos se ei toimi</h2>
      <p><strong>Ratkaisu:</strong> käy ongelma läpi järjestyksessä. Jos Helper ei näe Pixeliä lainkaan, tarkista että tunniste on liitetty lisäosaan oikein ja että lisäosa on aktiivinen. Yksi tavallinen syy on, ettei kävijän suostumusta evästeisiin ole annettu, jolloin Pixel ei käynnisty. Hyväksy banneri ja testaa uudelleen.</p>
      <p>Jos sivunkatselu toimii mutta osto ei kirjaudu, ongelma on tapahtuman määrityksessä. Verkkokaupassa varmista että maksun onnistumissivu laukaisee ostotapahtuman. Lomakkeessa varmista että seuranta on sidottu kiitossivuun. Jos sama tapahtuma kirjautuu kahdesti, sinulla on todennäköisesti kaksi päällekkäistä Pixel-asennusta, ja toinen pitää poistaa.</p>

      <h2>Tee tämä säännöllisesti</h2>
      <p>Pixel voi hajota ilman varoitusta, kun verkkosivua päivitetään, teema vaihtuu tai maksujärjestelmä uusitaan. Tarkista seuranta aina suuren sivustomuutoksen jälkeen ja pikaisesti pari kertaa vuodessa muutenkin. Pari minuuttia testausta säästää sinut tilanteelta, jossa olet mainostanut kuukausia datan kirjautumatta.</p>

      <h2>Usein kysytyt kysymykset</h2>
      <h3>Mikä on Meta Pixel Helper?</h3>
      <p>Se on ilmainen selainlaajennus, joka näyttää onko Pixel sivulla, mitkä tapahtumat kirjautuvat ja varoittaa yleisistä virheistä. Se on nopein tapa tarkistaa asennus.</p>
      <h3>Miksi Pixel ei kirjaa mitään vaikka asensin sen?</h3>
      <p>Yleisin syy on antamaton evästesuostumus, jolloin Pixel ei käynnisty. Muita syitä ovat väärin liitetty tunniste tai mainosten estäjä testaavassa selaimessa. Hyväksy banneri ja testaa ilman estäjää.</p>
      <h3>Riittääkö että sivunkatselu kirjautuu?</h3>
      <p>Ei. Tärkein testi on että ydintapahtumasi eli osto tai yhteydenotto kirjautuu. Juuri se tapahtuma vastaa rahaa, ja jos se ei toimi, mainonnan optimointi epäonnistuu.</p>
      <h3>Kuinka usein Pixel kannattaa testata?</h3>
      <p>Aina ison sivustomuutoksen jälkeen ja muutenkin pari kertaa vuodessa. Pixel voi hajota huomaamatta, ja säännöllinen tarkistus estää pitkät katkokset datassa.</p>
  ...
  {
    slug: 'meta-pixel-optimointi',
    title: 'Meta Pixel -optimointi: miksi optimoit väärää tapahtumaa',
    cats: ['Meta-pikseli'],
    date: '24.7.2026',
    publishedTime: '2026-07-24T07:36:00+03:00',
    read: 5,
    grad: 'grad-5',
    excerpt: 'Väärän pikselin tapahtuman optimointi on yksi kalleimmista Meta-mainonnan virheistä. Näin varmistat että optimoit oikeaa asiaa.',
    content: `
      <p>Kampanja saa paljon klikkejä, hinta näyttää matalalta, mutta tilipankissa ei tapahdu mitään. Yksi kalleimmista syistä tähän on väärän tapahtuman optimointi. Kerrot Metalle epähuomiossa, että haluat mahdollisimman paljon sivunkatseluja tai klikkejä, ja Meta tottelee kuuliaisesti. Se vain etsii halpoja klikkaajia, ei ostajia.</p>

      <h2>Mitä optimointi tarkoittaa</h2>
      <p>Kun rakennat kampanjan, valitset mihin tapahtumaan Meta optimoi. Tämä on käsky: etsi minulle lisää ihmisiä jotka tekevät juuri tämän. Jos valitset ostotapahtuman, Meta käyttää Pixelin keräämää dataa ja etsii ihmisiä jotka todennäköisesti ostavat. Jos valitset linkkiklikkauksen, Meta etsii ihmisiä jotka todennäköisesti klikkaavat, riippumatta siitä ostavatko he koskaan.</p>
      <p>Klikkaaja ja ostaja ovat eri ihmisiä. Halvat klikit houkuttelevat uteliaita selaajia, ei maksavia asiakkaita. Siksi optimointivalinta ratkaisee kampanjan kohtalon enemmän kuin moni budjettiin tai kuvaan liittyvä yksityiskohta.</p>
      ...
      <h2>Usein kysytyt kysymykset</h2>
      <h3>Mihin tapahtumaan minun pitäisi optimoida?</h3>
      <p>Lähimpänä rahaa olevaan tapahtumaan jota tulee riittävästi. Verkkokaupalle osto, palveluyritykselle yhteydenotto tai ajanvaraus. Vältä optimointia klikkiin tai sivunkatseluun, koska ne eivät vastaa myyntiä.</p>
      <h3>Mitä teen jos ostoja tulee liian vähän optimointiin?</h3>
      <p>Siirry väliaikaisesti yksi askel taaksepäin polulla, esimerkiksi ostoskoriin lisäykseen, jota tulee enemmän. Palaa optimoimaan suoraan ostoon heti kun myyntimäärä riittää, jotta Meta oppii oikeasta tapahtumasta.</p>
      <h3>Miksi halvat klikit eivät tuo myyntiä?</h3>
